# Bemerkung:
# Hat funktioniert ist die 2 Verison
...
foreach ($obj in $xml.SelectNodes("//ns:Obj", $namespace)) {
    ...
    Add-ADGroupMember -Identity $klasse -Members $benutzername -ErrorAction SilentlyContinue

    # Benutzer der zweiten Klasse hinzufügen
    Add-ADGroupMember -Identity $klasse2 -Members $benutzername -ErrorAction SilentlyContinue
